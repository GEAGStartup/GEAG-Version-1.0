...
class ConsumptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post consumptions_url, params: { consumption: { date: @consumption.date, meter_id: @consumption.meter_id, value: @consumption.value } }
    end
  ...
  test "should update consumption" do
    patch consumption_url(@consumption), params: { consumption: { date: @consumption.date, meter_id: @consumption.meter_id, value: @consumption.value } }
